    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}  >
      ...
      >
        <div className="relative w-full h-[230px] overflow-hidden rounded-2xl">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            <div
              ...
              className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer transition duration-500 transform hover:scale-110"
            >
              <img
                src={github}
                alt="github"
        ...
        <div className="mt-5">
          ...
          <p className="mt-2 text-white text-opacity-80 text-[16px]">
            {description}
          </p>
        </div>
    ...
    <>
      <div>
        <motion.div variants={textVariant()} className="mb-12">
          <p className={`${styles.sectionSubText} text-lg text-gray-400`}>
            My Work
          </p>
          <h2 className={`${styles.sectionHeadText} text-5xl text-white`}>
            Projects
          </h2>
        </motion.div>
      </div>
